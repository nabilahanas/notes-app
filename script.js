...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function createNoteElement(note) {
        ...
        titleSlot.textContent = note.title;

        const bodySlot = document.createElement('slot');
        bodySlot.setAttribute('name', 'body');
        bodySlot.textContent = note.body;

        noteElement.appendChild(titleSlot);
        noteElement.appendChild(bodySlot);
...
class NoteForm extends HTMLElement {
    constructor() {
        ...
        this.shadowRoot.innerHTML = `
        <form id="note-form">
            <h2>Write your note down below!</h2>
            <input type="text" id="title" placeholder="Title" required>
            <textarea id="body" placeholder="Notes" required></textarea>
